...
public class Login extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        Entrar.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
        ...
        Salir.setFont(new java.awt.Font("Times New Roman", 3, 18)); // NOI18N
...
private void EntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EntrarActionPerformed
  if (ClaseCuenta.Validar(TxtUsuario.getText(), TxtPassword.getText())) {        
        this.dispose();   
        
        if (TxtUsuario.getText().equals("a") && TxtPassword.getText().equals("a"))   {
